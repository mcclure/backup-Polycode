...
int luaopen_Polycode(lua_State *L) {
	static const struct luaL_reg polycoreLib [] = {		{"OSFILE_get_fileType", Polycore_OSFILE_get_fileType},
		...
		{"Renderer_setCurrentModelMatrix", Polycore_Renderer_setCurrentModelMatrix},
		{"Renderer_getCurrentModelMatrix", Polycore_Renderer_getCurrentModelMatrix},
		...
		{"Renderer_projectRayFrom2DCoordinate", Polycore_Renderer_projectRayFrom2DCoordinate},
		{"Renderer_enableShaders", Polycore_Renderer_enableShaders},
		{"Renderer_getViewportWidth", Polycore_Renderer_getViewportWidth},
		{"Renderer_getViewportHeight", Polycore_Renderer_getViewportHeight},
		...
		{"Scene_get_ownsCamera", Polycore_Scene_get_ownsCamera},
		...
		{"Scene_set_ownsCamera", Polycore_Scene_set_ownsCamera},
		...
		{"SceneMesh_get_ownsTexture", Polycore_SceneMesh_get_ownsTexture},
		...
		{"SceneMesh_set_ownsTexture", Polycore_SceneMesh_set_ownsTexture},
		...
		{"Screen_get_ownsChildren", Polycore_Screen_get_ownsChildren},
		{"Screen_set_enabled", Polycore_Screen_set_enabled},
		{"Screen_set_ownsChildren", Polycore_Screen_set_ownsChildren},
